 ...
 *                 Project Name : PS6                                                          *
 *                                                                                             *
 *                        File  : Views/HelpAdditionalFeatures.cs                              *
 *                                                                                             *
 *                       Author : Josh Perkins                                                 *
 *                                                                                             *
 *                   Start Date : 10/14/18                                                     *
...
namespace SS.Views {
    ...
    /// <summary>
    /// Respresents a help window that explains additional features of the program.
    /// </summary>
    public partial class HelpAdditionalFeatures : Form {

        /// <summary>
        /// Basic constructor.
        /// </summary>
        /// <param name="mode">Determines whether the theme is set to dark mode.</param>
        public HelpAdditionalFeatures(bool mode) {
            InitializeComponent();
            DarkMode(mode);
        }
